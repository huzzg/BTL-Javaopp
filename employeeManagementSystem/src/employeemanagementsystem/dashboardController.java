...
public class dashboardController implements Initializable {
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == home_btn) {
            ...
            home_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #5C469C, #d4adfc);");
            ...
            addEmployee_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #5C469C, #d4adfc);");
            ...
            salary_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #5C469C, #d4adfc);");
            addEmployee_btn.setStyle("-fx-background-color:transparent");
            home_btn.setStyle("-fx-background-color:transparent");
